...
<div class="pb-2 pt-4">
	<h2 class="HEADER pb-2 text-center text-3xl font-semibold text-aisha" id="ProjectInfo">
		PROJECT OVERALL
	</h2>
	...
	<p class="mx-auto px-2 pt-4 text-center text-xs md:text-lg">
		เพื่อระดมทุนทำป้ายโฆษณา LED Billboard Happy Birthday Aisha Project, Happy birthday cake
		และร้านน้ำ Chatime เนื่องจากฉลองวันเกิดของ Virtual Idol Aisha งบประมาณที่ต้องการ 60,000 บาท
	</p>
	<div class="my-2 grid grid-cols-1 space-y-1 md:-my-2 md:grid-cols-2 md:space-y-4">
		...
		<div class="mx-auto md:mx-8">
			...
			<ul class="mt-1 list-inside list-disc md:mt-0">
				...
				<li>ค่าเค้กวันเกิด</li>
				<li>ค่าเช่าร้านน้ำ Chatime</li>
				<li>ค่าทำ x stand วันเกิดไอช่า</li>
				<li>ค่าทำ cup sleeve วันเกิดไอช่า</li>
				<li>ค่าซองจดหมาย</li>
				<li>ค่าอุปกรณ์</li>
				<li>ค่าจัดส่ง</li>
			</ul>
