...
<div class="max-w-4xl h-48 md:h-60">
	<iframe
			width="100%"
			height="100%"
			src="http://www.youtube.com/embed/vyR5W0PNxwo?autoplay=1&mute=1&controls=0&loop=1&playlist=vyR5W0PNxwo&enablejsapi=1&origin=https%3A%2F%guppiens.com&widgetid=1"
			id="widget2"
	/>
</div>
